    ...
    return _regeneratorRuntime().wrap(function _callee3$(_context3) {
      while (1) switch (_context3.prev = _context3.next) {
        ...
        case 7:
          ...
          _sweetalert.default.fire({
            title: "<h1 style='font-size: 24px;'>Error</h1>",
            html: "<div style='font-size: 18px;'>".concat(_context3.t0.response.data.message, "</div>"),
            icon: "error",
            showCancelButton: false,
            showConfirmButton: true,
            dangerMode: true,
...
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"mapBox.js":[function(require,module,exports) {
"use strict";
...
function asyncGeneratorStep(gen, resolve, reject, _next, _throw, key, arg) { try { var info = gen[key](arg); var value = info.value; } catch (error) { reject(error); return; } if (info.done) { resolve(value); } else { Promise.resolve(value).then(_next, _throw); } }
function _asyncToGenerator(fn) { return function () { var self = this, args = arguments; return new Promise(function (resolve, reject) { var gen = fn.apply(self, args); function _next(value) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "next", value); } function _throw(err) { asyncGeneratorStep(gen, resolve, reject, _next, _throw, "throw", err); } _next(undefined); }); }; }
var settingUser = exports.settingUser = /*#__PURE__*/function () {
  ...
  return function settingUser(_x) {
    return _ref.apply(this, arguments);
  };
}();
...
},{"axios":"../../node_modules/axios/index.js","sweetalert2":"../../node_modules/sweetalert2/dist/sweetalert2.all.js"}],"review.js":[function(require,module,exports) {
"use strict";
...
var reviewTour = exports.reviewTour = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee2(review, tour, rating) {
    var res;
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
  ...
  return function reviewTour(_x4, _x5, _x6) {
    return _ref2.apply(this, arguments);
  };
}();
...
if (savePassForm) {
  savePassForm.addEventListener("submit", /*#__PURE__*/function () {
      ...
      return _regeneratorRuntime().wrap(function _callee$(_context) {
        while (1) switch (_context.prev = _context.next) {
          case 0:
            ...
            _context.next = 6;
            return (0, _settings.updatePassword)(passwordCurrent, password, passwordConfirm);
          case 6:
...
var btnBook1 = document.getElementById("book-tour1");
if (btnBook1) {
  btnBook1.addEventListener("click", function (e) {
    var tourId = e.target.dataset.tourId;
    (0, _stripe.bookTour)(tourId);
  });
}
var reviewForm = document.querySelector(".form--review");
var reviewCheckboxes = document.querySelectorAll(".form--review .ch");
var labelStar = document.querySelectorAll(".fa-star");
if (reviewCheckboxes.length > 0) {
  var count = 0;
  var coutInput = document.getElementById("name");
  var reviewInput = document.getElementById("reviews");
  reviewCheckboxes.forEach(function (checkbox, index) {
  ...
  reviewForm.addEventListener("submit", function (e) {
    ...
    var tourId_ = coutInput.name;
    var countTotal = coutInput.value;
    (0, _review.reviewTour)(reviewText, tourId_, countTotal);
  });
} else {
  console.error("No review checkboxes found.");
}
var btnSignup = document.querySelector(".form--signup");
if (btnSignup) {
